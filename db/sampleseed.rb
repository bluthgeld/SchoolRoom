...
studentcare29 = CareStudent.find_or_create_by(student_id: student30.id, caregiver_id: caregive9.id)
...
educatorstudent1 = EducatorStudent.create(student_id: student1.id, educator_id: fred.id)
educatorstudent2 = EducatorStudent.create(student_id: student2.id, educator_id: fred.id)
educatorstudent3 = EducatorStudent.create(student_id: student3.id, educator_id: fred.id)
educatorstudent4 = EducatorStudent.create(student_id: student4.id, educator_id: fred.id)
educatorstudent5 = EducatorStudent.create(student_id: student5.id, educator_id: fred.id)
educatorstudent6 = EducatorStudent.create(student_id: student6.id, educator_id: fred.id)
educatorstudent7 = EducatorStudent.create(student_id: student7.id, educator_id: fred.id)
educatorstudent8 = EducatorStudent.create(student_id: student8.id, educator_id: fred.id)
educatorstudent9 = EducatorStudent.create(student_id: student9.id, educator_id: fred.id)
educatorstudent10 = EducatorStudent.create(student_id: student10.id, educator_id: fred.id)
educatorstudent11 = EducatorStudent.create(student_id: student11.id, educator_id: fred.id)
educatorstudent12 = EducatorStudent.create(student_id: student12.id, educator_id: fred.id)
educatorstudent13 = EducatorStudent.create(student_id: student13.id, educator_id: fred.id)
educatorstudent14 = EducatorStudent.create(student_id: student14.id, educator_id: fred.id)
educatorstudent15 = EducatorStudent.create(student_id: student15.id, educator_id: fred.id)
educatorstudent16 = EducatorStudent.create(student_id: student16.id, educator_id: fred.id)
educatorstudent17 = EducatorStudent.create(student_id: student17.id, educator_id: fred.id)
educatorstudent18 = EducatorStudent.create(student_id: student18.id, educator_id: fred.id)
educatorstudent19 = EducatorStudent.create(student_id: student19.id, educator_id: fred.id)
educatorstudent20 = EducatorStudent.create(student_id: student20.id, educator_id: fred.id)
educatorstudent21 = EducatorStudent.create(student_id: student21.id, educator_id: paul.id)
educatorstudens22 = EducatorStudent.create(student_id: student22.id, educator_id: paul.id)
educatorstudent23 = EducatorStudent.create(student_id: student23.id, educator_id: paul.id)
educatorstudent24 = EducatorStudent.create(student_id: student24.id, educator_id: paul.id)
educatorstudent25 = EducatorStudent.create(student_id: student25.id, educator_id: paul.id)
educatorstudent26 = EducatorStudent.create(student_id: student26.id, educator_id: paul.id)
educatorstudent27 = EducatorStudent.create(student_id: student27.id, educator_id: paul.id)
educatorstudent28 = EducatorStudent.create(student_id: student28.id, educator_id: paul.id)
educatorstudent29 = EducatorStudent.create(student_id: student29.id, educator_id: paul.id)
educatorstudent30 = EducatorStudent.create(student_id: student30.id, educator_id: paul.id)
educatorstudent31 = EducatorStudent.create(student_id: student31.id, educator_id: paul.id)
educatorstudent32 = EducatorStudent.create(student_id: student32.id, educator_id: paul.id)
educatorstudent33 = EducatorStudent.create(student_id: student33.id, educator_id: paul.id)
educatorstudent34 = EducatorStudent.create(student_id: student34.id, educator_id: paul.id)
educatorstudent35 = EducatorStudent.create(student_id: student35.id, educator_id: paul.id)
educatorstudent36 = EducatorStudent.create(student_id: student36.id, educator_id: paul.id)
educatorstudent37 = EducatorStudent.create(student_id: student37.id, educator_id: paul.id)
educatorstudent38 = EducatorStudent.create(student_id: student38.id, educator_id: paul.id)
educatorstudent39 = EducatorStudent.create(student_id: student39.id, educator_id: paul.id)
educatorstudent40 = EducatorStudent.create(student_id: student40.id, educator_id: paul.id)

notification1 = Notification.create(subject: "A Message", message: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Mauris dapibus ornare ante, sit amet mollis sapien porta ultrices. Vestibulum nec augue vitae elit consequat mollis non sed eros. Fusce mattis sapien eu augue consequat, vitae cursus sapien consequat. Donec condimentum vel risus eget vulputate. Nam tristique augue gravida neque luctus, a ornare nunc posuere. Mauris nec orci ipsum. Praesent condimentum imperdiet velit eget aliquam. Phasellus non odio ut nibh rutrum fringilla. Morbi fermentum mollis ante, in viverra ante vulputate in. Integer vehicula odio aliquam commodo vulputate. Donec tempus justo eu urna volutpat finibus. In vitae ornare libero. Integer iaculis consectetur.", student_id: student1.id, educator_id: paul.id)
notification2 = Notification.create(subject: "A Message", message: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Mauris dapibus ornare ante, sit amet mollis sapien porta ultrices. Vestibulum nec augue vitae elit consequat mollis non sed eros. Fusce mattis sapien eu augue consequat, vitae cursus sapien consequat. Donec condimentum vel risus eget vulputate. Nam tristique augue gravida neque luctus, a ornare nunc posuere. Mauris nec orci ipsum. Praesent condimentum imperdiet velit eget aliquam. Phasellus non odio ut nibh rutrum fringilla. Morbi fermentum mollis ante, in viverra ante vulputate in. Integer vehicula odio aliquam commodo vulputate. Donec tempus justo eu urna volutpat finibus. In vitae ornare libero. Integer iaculis consectetur.", student_id: student2.id, educator_id: paul.id)
notification3 = Notification.create(subject: "A Message", message: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Mauris dapibus ornare ante, sit amet mollis sapien porta ultrices. Vestibulum nec augue vitae elit consequat mollis non sed eros. Fusce mattis sapien eu augue consequat, vitae cursus sapien consequat. Donec condimentum vel risus eget vulputate. Nam tristique augue gravida neque luctus, a ornare nunc posuere. Mauris nec orci ipsum. Praesent condimentum imperdiet velit eget aliquam. Phasellus non odio ut nibh rutrum fringilla. Morbi fermentum mollis ante, in viverra ante vulputate in. Integer vehicula odio aliquam commodo vulputate. Donec tempus justo eu urna volutpat finibus. In vitae ornare libero. Integer iaculis consectetur.", student_id: student3.id, educator_id: paul.id)
notification4 = Notification.create(subject: "A Message", message: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Mauris dapibus ornare ante, sit amet mollis sapien porta ultrices. Vestibulum nec augue vitae elit consequat mollis non sed eros. Fusce mattis sapien eu augue consequat, vitae cursus sapien consequat. Donec condimentum vel risus eget vulputate. Nam tristique augue gravida neque luctus, a ornare nunc posuere. Mauris nec orci ipsum. Praesent condimentum imperdiet velit eget aliquam. Phasellus non odio ut nibh rutrum fringilla. Morbi fermentum mollis ante, in viverra ante vulputate in. Integer vehicula odio aliquam commodo vulputate. Donec tempus justo eu urna volutpat finibus. In vitae ornare libero. Integer iaculis consectetur.", student_id: student4.id, educator_id: fred.id)
notification5 = Notification.create(subject: "A Message", message: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Mauris dapibus ornare ante, sit amet mollis sapien porta ultrices. Vestibulum nec augue vitae elit consequat mollis non sed eros. Fusce mattis sapien eu augue consequat, vitae cursus sapien consequat. Donec condimentum vel risus eget vulputate. Nam tristique augue gravida neque luctus, a ornare nunc posuere. Mauris nec orci ipsum. Praesent condimentum imperdiet velit eget aliquam. Phasellus non odio ut nibh rutrum fringilla. Morbi fermentum mollis ante, in viverra ante vulputate in. Integer vehicula odio aliquam commodo vulputate. Donec tempus justo eu urna volutpat finibus. In vitae ornare libero. Integer iaculis consectetur.", student_id: student5.id, educator_id: fred.id)
notification6 = Notification.create(subject: "A Message", message: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Mauris dapibus ornare ante, sit amet mollis sapien porta ultrices. Vestibulum nec augue vitae elit consequat mollis non sed eros. Fusce mattis sapien eu augue consequat, vitae cursus sapien consequat. Donec condimentum vel risus eget vulputate. Nam tristique augue gravida neque luctus, a ornare nunc posuere. Mauris nec orci ipsum. Praesent condimentum imperdiet velit eget aliquam. Phasellus non odio ut nibh rutrum fringilla. Morbi fermentum mollis ante, in viverra ante vulputate in. Integer vehicula odio aliquam commodo vulputate. Donec tempus justo eu urna volutpat finibus. In vitae ornare libero. Integer iaculis consectetur.", student_id: student6.id, educator_id: fred.id)
